...
CytronMD motor_left(PWM_PWM, 7, 6);   // PWM 1A = Pin 3, PWM 1B = Pin 2.
CytronMD motor_right(PWM_PWM, 9, 8);   // PWM 2A = Pin 5, PWM 2B = Pin 4.

//****** Left Motor Encoder Pins **********
#define ENCLA 19 // YELLOW
#define ENCLB 18 // GREEN


//****** Right Motor Encoder Pins **********
#define ENCRA 17 // YELLOW
#define ENCRB 16 // GREEN
...
float count_per_rev_lm = 225.0;// <======== set this number according to your motor (count per rev) for left motor

float count_per_rev_rm = 225.0;// <======== set this number according to your motor (count per rev) for right motor
...
double LM_kp = 1.5, LM_ki = 0.0 , LM_kd = 0.0500;          // modify for optimal performance
...
double RM_kp = 1.5, RM_ki = 0.0 , RM_kd = 0.0500;          // modify for optimal performance
